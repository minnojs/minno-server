...
(function () {
    ...
    function controller$3(settings, defaultSettings, clearElement, subTabs, taskType){
    ...
    function view$3(ctrl, settings, defaultSettings, clearElement, subTabs, taskType) {
        return m('.container.space', [
            ...
            m('.div',
                taskType === 'BIAT' ?
                    m.component(elementComponent$2,{key:ctrl.curr_tab}, settings,
    ...
    let tabs = [
        ...
        {value: 'practice', text: 'Practice Block', component: categoriesComponent, rowsDesc: elementClear, subTabs:practiceTabs, type: 'BIAT'},
        {value: 'categories', text: 'Categories', component: categoriesComponent$1, rowsDesc: elementClear},
        {value: 'attributes', text: 'Attributes', component: categoriesComponent, rowsDesc: elementClear, subTabs:attributesTabs, type: 'BIAT'},
