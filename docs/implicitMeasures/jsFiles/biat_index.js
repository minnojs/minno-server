...
(function () {
    ...
    function controller$5(object, settings, stimuliList, taskType){
        let element = settings[object.key];
        let fields = {
            newStimulus : m.prop(''),
            selectedStimuli: m.prop(''),
    ...
    function controller$4(taskType, settings, elementName){
    ...
    function view$3(ctrl, settings, defaultSettings, clearElement, taskType, currTab) {
        return m('div', [
            taskType === 'BIAT' ?
