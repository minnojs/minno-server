            ...
            questions:[
                {
                    ...
                    description: '' +
						...
						'<div class="jumbotron jumbotron-dark">' +
						  ...
						  '<p><%= global.skiniat.feedback %></p>' +
						'</div>' +

					    '<p>Your result is described as an "Automatic preference for Dark Skinned People over Light Skinned People" if you were faster responding when <i>Dark Skinned People</i> and <i>Good</i> are assigned to the same response key than when <i>Light Skinned People</i> and <i>Good</i> were classified with the same key. Your score is described as an "Automatic preference for Light Skinned People over Dark Skinned People" if the opposite occurred.</p>' +
