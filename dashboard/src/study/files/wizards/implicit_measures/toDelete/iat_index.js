...
(function (modelHelpers, modelUrls) {
    ...
    function showRestrictions(text, title = ''){
    ...
    function updateSettings$1(settings){
        ...
        if(settings.parameters.isQualtrics){
            ...
            console.log(settings.parameters.leftKey, settings.parameters.rightKey);
    ...
    function controller$5(settings, defaultSettings, rows){
        ...
        function reset(){showClearOrReset$1(blocks, defaultSettings.blocks,'reset');}
        function clear(){showClearOrReset$1(blocks, rows.slice(-1)[0],'clear');}
    ...
    function controller$2(settings, defaultSettings, clearElement, subTabs){
        ...
        function reset(){showClearOrReset$1(settings[this.curr_tab], defaultSettings[this.curr_tab],'reset');}
        function clear(){showClearOrReset$1(settings[this.curr_tab],clearElement[0],'clear');}

    }

    function view$2(ctrl, settings, defaultSettings, clearElement, subTabs, isBiat) {
        return m('.container.space', [
    ...
    function updateSettings(settings, input) {
        ...
        if(input.isQualtrics){
            ...
            console.log(input.leftKey, input.rightKey, input.isQualtrics);
        ...
        if(!ctrl.external) {
            return !ctrl.loaded()
                ...
                m('div', ctrl.notifications.view()),
                    ...
                    m.component(tabsComponent, tabs, ctrl.settings, settings$1, ctrl.external, ctrl.is_locked())
        ])
        }
        return m('.container',
            m('div', ctrl.notifications.view()),
                m('h1.display-3', 'Create my IAT script'),
