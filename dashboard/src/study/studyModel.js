...
export let get_stat = (study_id, start_date, end_date, sort_version, sort_experiment, sort_day, first_task, last_task) => fetchJson(get_stat_url(study_id), {
    method: 'post',
    body: {start_date, end_date, sort_version, sort_experiment, sort_day, first_task, last_task}
});
