			...
			questions:[
				{
					...
					name: 'iatresults',
					description: '' +
						'<p>The sorting test you just took is called the Implicit Association Test (IAT). You categorized words of Good and Bad with words of Arab Muslims and Other People.</p>' +
						'<div class="jumbotron jumbotron-dark">' +
						  '<h2>Here is your result:</h2>' +
						  '<p><%= global.arabiat.feedback %></p>' +
						'</div>' +

					    '<p>Your result is described as an "Automatic preference for Arab Muslims" if you were faster responding when <i>Arab Muslims</i> and <i>Good</i> are assigned to the same response key than when <i>Other People</i> and <i>Good</i> were classified with the same key. Your score is described as an "Automatic preference for Other People" if the opposite occurred.</p>' +
					    '<p>Your automatic association may be described as "slight", "moderate", "strong", or "no association". This indicates the <i>strength</i> of your automatic association.</p>' +
